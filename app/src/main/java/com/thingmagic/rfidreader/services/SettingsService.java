...
public class SettingsService {
	...
	public SettingsService(Activity serviceActivity){
	...
	{
		embeddedCheckBox =(CheckBox)activity.findViewById(R.id.embedded_enabled);
		memBankSpinner =(Spinner)activity.findViewById(R.id.embedded_bank);
		embedded_start_view =(EditText)activity.findViewById(R.id.embedded_start);
		embedded_length_view =(EditText)activity.findViewById(R.id.embedded_length);
	}
